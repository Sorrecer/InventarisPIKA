                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 mx-auto" style="width:50%">
                        <div class="card-header py-3">
                            <div class="row">
                                <div class="col my-2">
                                    <h6 class="m-0 font-weight-bold text-primary">Form penambahan jenis barang</h6>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <select class="form-control <?= ($validation->hasError('id_kategori')) ?
                                        ...
                                        <?php if ($kategori) : ?>
                                            <?php foreach ($kategori as $rowkategori) : ?>
                                                <option value="<?php echo $rowkategori['id_kategori'] ?>"><?php echo $rowkategori['nama_kategori'] ?></option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                    <div class="invalid-feedback">
