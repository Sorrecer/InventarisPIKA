...
<body id="page-top">
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Lihat Data Barang</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <a class="col-xl-3 col-md-6 mb-4" href="<?php echo base_url('barang-masuk'); ?>">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Input Barang Masuk</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">Rekap Data Barang</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
    ...
    <script>
        ...
        var myBarChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: [<?php foreach ($barmasuk as $i) echo "'$i[nama_barang]',"  ?>],
                datasets: [{
                    label: "Jumlah Barang",
                    backgroundColor: "#4e73df",
                    hoverBackgroundColor: "#2e59d9",
                    borderColor: "#4e73df",
                    data: [<?php foreach ($barmasuk as $i) echo "$i[jumlah],"  ?>],
                }],
            },
            options: {
    ...
    <script>
        ...
        var myBarChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: [<?php foreach ($barkeluar as $i) echo "'$i[nama_barang]',"  ?>],
                datasets: [{
                    label: "Jumlah Barang",
                    backgroundColor: "#4e73df",
                    hoverBackgroundColor: "#2e59d9",
                    borderColor: "#4e73df",
                    data: [<?php foreach ($barkeluar as $i) echo "$i[jumlah],"  ?>],
                }],
            },
            options: {
                maintainAspectRatio: false,
        ...
        var myLineChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    pointHitRadius: 10,
                    pointBorderWidth: 2,
                    <?php foreach ($frekuensi as $i) $frek[$i['bulan']] = $i['jumlah'] ?>
                    data: [<?php for ($i = 1; $i <= 12; $i++) echo ($frek[$i] ?? 0) . ',' ?>],
                }],
            },
            options: {
                maintainAspectRatio: false,
