                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th class="sorting sorting_asc" tabindex="5" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 100px;" aria-sort="ascending" aria-label="Keterangan: activate to sort column descending">Keterangan</th>
                                        ...
                                        <?php if ($barang_keluar) : ?>
                                            <?php foreach ($barang_keluar as $i => $rowkeluar) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url("barangkeluar/edit/" . $rowkeluar['id_transaksi']) ?>" class="btn btn-warning">
                                                            <span class="text">Edit</span>
                                                        </a>
                                                        <a href="#" onclick="konfirmasi(<?php echo $rowkeluar['id_transaksi'] ?>)" class="btn btn-danger">Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
        ...
        function konfirmasi(id_transaksi) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "<?php echo base_url('barangkeluar/delete') ?>/" +
                        id_transaksi;
                }
            })
        }
