            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 mx-auto" style="width:50%">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url("AkunStaff/update/" . $id_user) ?>" method="POST">
                                ...
                                <div class=" form-group">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('username')) ?
                                                                                'is-invalid' : '' ?>" id="username" name="username" value="<?php echo $staff['username']; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control <?= ($validation->hasError('email')) ?
                                                                                'is-invalid' : '' ?>" id="email" name="email" value="<?php echo $staff['email']; ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('telepon')) ?
                                                                                'is-invalid' : '' ?>" id="telepon" name="telepon" value="<?php echo $staff['telepon']; ?>">
                                    <div class="invalid-feedback">
